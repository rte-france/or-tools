...
class XpressHeaderParser(object):
    ...
    def __init__(self):
        ...
        self.__required_defines = {"XPRS_PLUSINFINITY", "XPRS_MINUSINFINITY", "XPRS_MAXBANNERLENGTH", "XPVERSION",
                                   ...
                                   "XPRS_PIVOTTOL",
                                   "XPRS_FEASTOL", "XPRS_OUTPUTTOL", "XPRS_SOSREFTOL", "XPRS_OPTIMALITYTOL",
                                   "XPRS_ETATOL", "XPRS_RELPIVOTTOL", "XPRS_MIPTOL", "XPRS_MIPTOLTARGET",
                                   "XPRS_BARPERTURB", "XPRS_MIPADDCUTOFF", "XPRS_MIPABSCUTOFF", "XPRS_MIPRELCUTOFF",
                                   "XPRS_PSEUDOCOST", "XPRS_PENALTY", "XPRS_BIGM", "XPRS_MIPABSSTOP", "XPRS_MIPRELSTOP",
                                   "XPRS_CROSSOVERACCURACYTOL", "XPRS_PRIMALPERTURB", "XPRS_DUALPERTURB",
                                   "XPRS_BAROBJSCALE", "XPRS_BARRHSSCALE", "XPRS_CHOLESKYTOL", "XPRS_BARGAPSTOP",
                                   "XPRS_BARDUALSTOP", "XPRS_BARPRIMALSTOP", "XPRS_BARSTEPSTOP", "XPRS_ELIMTOL",
                                   "XPRS_PERTURB", "XPRS_MARKOWITZTOL", "XPRS_MIPABSGAPNOTIFY", "XPRS_MIPRELGAPNOTIFY",
                                   "XPRS_BARLARGEBOUND", "XPRS_PPFACTOR", "XPRS_REPAIRINDEFINITEQMAX",
                                   "XPRS_BARGAPTARGET", "XPRS_BARSTARTWEIGHT", "XPRS_BARFREESCALE", "XPRS_SBEFFORT",
                                   ...
                                   "XPRS_MAXMIPSOL",
                                   "XPRS_SIFTPASSES", "XPRS_DEFAULTALG", "XPRS_VARSELECTION", "XPRS_NODESELECTION",
                                   "XPRS_BACKTRACK", "XPRS_MIPLOG", "XPRS_KEEPNROWS", "XPRS_MPSECHO",
                                   "XPRS_MAXPAGELINES",
                                   "XPRS_OUTPUTLOG", "XPRS_BARSOLUTION", "XPRS_CACHESIZE", "XPRS_CROSSOVER",
                                   "XPRS_BARITERLIMIT", "XPRS_CHOLESKYALG", "XPRS_BAROUTPUT", "XPRS_CSTYLE",
                                   "XPRS_EXTRAMIPENTS", "XPRS_REFACTOR", "XPRS_BARTHREADS", "XPRS_KEEPBASIS",
                                   "XPRS_CROSSOVEROPS", "XPRS_VERSION", "XPRS_CROSSOVERTHREADS", "XPRS_BIGMMETHOD",
                                   "XPRS_MPSNAMELENGTH", "XPRS_ELIMFILLIN", "XPRS_PRESOLVEOPS", "XPRS_MIPPRESOLVE",
                                   "XPRS_MIPTHREADS", "XPRS_BARORDER", "XPRS_BREADTHFIRST", "XPRS_AUTOPERTURB",
                                   "XPRS_DENSECOLLIMIT", "XPRS_CALLBACKFROMMASTERTHREAD", "XPRS_MAXMCOEFFBUFFERELEMS",
                                   "XPRS_REFINEOPS", "XPRS_LPREFINEITERLIMIT", "XPRS_MIPREFINEITERLIMIT",
                                   "XPRS_DUALIZEOPS", "XPRS_CROSSOVERITERLIMIT", "XPRS_PREBASISRED", "XPRS_PRESORT",
                                   "XPRS_PREPERMUTE", "XPRS_PREPERMUTESEED", "XPRS_MAXMEMORYSOFT", "XPRS_CUTFREQ",
                                   "XPRS_SYMSELECT", "XPRS_SYMMETRY", "XPRS_MAXMEMORYHARD", "XPRS_LPTHREADS",
                                   "XPRS_MIQCPALG", "XPRS_QCCUTS", "XPRS_QCROOTALG", "XPRS_PRECONVERTSEPARABLE",
                                   "XPRS_ALGAFTERNETWORK", "XPRS_TRACE", "XPRS_MAXIIS", "XPRS_CPUTIME",
                                   "XPRS_COVERCUTS",
                                   "XPRS_GOMCUTS", "XPRS_LPFOLDING", "XPRS_MPSFORMAT", "XPRS_CUTSTRATEGY",
                                   "XPRS_CUTDEPTH", "XPRS_TREECOVERCUTS", "XPRS_TREEGOMCUTS", "XPRS_CUTSELECT",
                                   "XPRS_TREECUTSELECT", "XPRS_DUALIZE", "XPRS_DUALGRADIENT", "XPRS_SBITERLIMIT",
                                   "XPRS_SBBEST", "XPRS_MAXCUTTIME", "XPRS_ACTIVESET", "XPRS_BARINDEFLIMIT",
                                   "XPRS_HEURSTRATEGY", "XPRS_HEURFREQ", "XPRS_HEURDEPTH", "XPRS_HEURMAXSOL",
                                   "XPRS_HEURNODES", "XPRS_LNPBEST", "XPRS_LNPITERLIMIT", "XPRS_BRANCHCHOICE",
                                   "XPRS_BARREGULARIZE", "XPRS_SBSELECT", "XPRS_LOCALCHOICE", "XPRS_LOCALBACKTRACK",
                                   "XPRS_DUALSTRATEGY", "XPRS_LCACHE", "XPRS_HEURDIVESTRATEGY", "XPRS_HEURSELECT",
                                   "XPRS_BARSTART", "XPRS_PRESOLVEPASSES", "XPRS_BARNUMSTABILITY",
                                   ...
                                   "XPRS_MPSCOMPATIBLE", "XPRS_ROOTPRESOLVE", "XPRS_CROSSOVERDRP", "XPRS_FORCEOUTPUT",
                                   "XPRS_DETERMINISTIC", "XPRS_PREPROBING", "XPRS_EXTRAQCELEMENTS", "XPRS_EXTRAQCROWS",
                                   "XPRS_TREEMEMORYLIMIT", "XPRS_TREECOMPRESSION", "XPRS_TREEDIAGNOSTICS",
                                   "XPRS_MAXGLOBALFILESIZE", "XPRS_PRECLIQUESTRATEGY", "XPRS_REPAIRINFEASMAXTIME",
                                   "XPRS_IFCHECKCONVEXITY", "XPRS_PRIMALUNSHIFT", "XPRS_REPAIRINDEFINITEQ",
                                   "XPRS_MIPRAMPUP", "XPRS_MAXLOCALBACKTRACK", "XPRS_USERSOLHEURISTIC",
                                   "XPRS_FORCEPARALLELDUAL", "XPRS_BACKTRACKTIE", "XPRS_BRANCHDISJ",
                                   "XPRS_MIPFRACREDUCE",
                                   ...
                                   "XPRS_MIPRESTART",
                                   "XPRS_CONFLICTCUTS", "XPRS_PREPROTECTDUAL", "XPRS_CORESPERCPU",
        ...
        self.__required_functions = {"XPRScreateprob", "XPRSdestroyprob", "XPRSinit", "XPRSfree", "XPRSgetlicerrmsg",
                                     ...
                                     "XPRSsetstrcontrol",
                                     "XPRSgetintcontrol", "XPRSgetintcontrol64", "XPRSgetdblcontrol",
                                     "XPRSgetstringcontrol", "XPRSgetintattrib", "XPRSgetdblattrib", "XPRSloadlp",
                                     "XPRSloadlp64", "XPRSgetobj", "XPRSgetrhs", "XPRSgetrhsrange", "XPRSgetlb",
                                     "XPRSgetub", "XPRSgetcoef", "XPRSaddrows", "XPRSdelrows", "XPRSaddcols",
                                     "XPRSdelcols", "XPRSchgcoltype", "XPRSloadbasis", "XPRSpostsolve",
                                     "XPRSchgobjsense",
                                     "XPRSgetlasterror", "XPRSgetbasis", "XPRSwriteprob", "XPRSgetrowtype",
                                     "XPRSgetcoltype", "XPRSgetlpsol", "XPRSgetmipsol", "XPRSchgbounds", "XPRSchgobj",
                                     "XPRSchgcoef", "XPRSchgmcoef", "XPRSchgrhs", "XPRSchgrhsrange", "XPRSchgrowtype",
                                     "XPRSsetcbmessage", "XPRSminim", "XPRSmaxim"}
